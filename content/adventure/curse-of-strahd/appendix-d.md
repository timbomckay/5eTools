...
| Creature | <span class="text-center block">CR</span> |
| - | - |
| **area Baba Lysaga** | <span class="text-center block">11</span> |
| **area Baba Lysaga's creeping hut** | <span class="text-center block">11</span> |
| **area Broom of animated attack** | <span class="text-center block">1/4</span> |
| **area Barovian witch** | <span class="text-center block">1/2</span> |
| Ezmerelda d'Avenir | <span class="text-center block">8</span> |
| **area Guardian portrait** | <span class="text-center block">1</span> |
| **area Izek Strazni** | <span class="text-center block">5</span> |
| **area Madam Eva** | <span class="text-center block">10</span> |
| **area Mongrelfolk** | <span class="text-center block">1/4</span> |
| **area Phantom warrior** | <span class="text-center block">3</span> |
| **area Pidlwick II** | <span class="text-center block">1/4</span> |
| **area Rahadin** | <span class="text-center block">10</span> |
| **area Rictavio** | <span class="text-center block">5</span> |
| **area Strahd's animated armor** | <span class="text-center block">6</span> |
| **area Strahd von Zarovich** | <span class="text-center block">15</span> |
| **area Strahd zombie** | <span class="text-center block">1</span> |
| **area Tree blight** | <span class="text-center block">7</span> |
| **area Vladimir Horngaard** | <span class="text-center block">7</span> |
| **area Wereraven** | <span class="text-center block">2</span> |
...
Use the deva stat block in the Monster Manual, but change The Abbot alignment to lawful evil.
...
Removing the gem from the hut renders the hut <wc-fetch type="condition">incapacitated</wc-fetch>. That task is easier said than done, however. The glowing green gem is contained in a cavity in the stump, beneath the rotted floorboards of the hut. The floorboards can be ripped up with a successful DC 14 Strength check or smashed by dealing 10 damage to them. Once the floorboards are out of the way, a creature can reach into the cavity and snatch the gem. But if someone attempts this while the hut is alive, the cavity sprouts wooden teeth, becoming a mouth that bites anything that tries to remove the gem; a creature trying to remove the gem must make a DC 20 Dexterity saving throw. On a successful save, the creature claims the stone without getting bitten. On a failed save, the creature is bitten for 10 (<wc-roll>3d6</wc-roll>) piercing damage and fails to obtain the gem.

##### Broom of Animated Attack

A broom of animated attack is easily mistaken for a <wc-fetch type="item">broom of flying</wc-fetch>. It attacks any creature that grabs it or tries to ride it.

###### Flying Broom

Some Broom of Animated Attack allow their creators to ride them, in which case they behave like typical <wc-fetch type="item">Broom of Flying</wc-fetch>. A broom of animated attack, however, can carry only half the weight that a <wc-fetch type="item">broom of flying</wc-fetch> can (see chapter 7, "Treasure," of the Dungeon Master's Guide).
...
The eyes of the figure depicted in the painting are imbued with <wc-fetch type="sense">darkvision</wc-fetch>, and they appear to follow creatures that move in front of them.
...
The Strahd's Animated Armor that Strahd wore into battle when he was alive lives on today as a headless, animated suit of plate armor. The armor is painted burgundy and adorned with golden angelic motifs.
...
![{@creature Strahd's Animated Armor|CoS}](adventure/CoS/143-636623960253938131.png)
...
![{@creature Baba Lysaga|CoS}](adventure/CoS/144-636379873620950408.png)

#### Barovian Witch

The mad women and men known as Barovian Witch forge pacts with Strahd and the Dark Powers of Ravenloft in exchange for magic and longevity. They prefer to live in the shadows and can see in the dark. When traveling in the open, they use <wc-fetch type="spell">alter self</wc-fetch> spells to assume less conspicuous forms. They also use these spells to grow long, sharp claws with which they can attack.
...
Barovian witches use the <wc-fetch type="spell">find familiar</wc-fetch> spell to call forth familiars. They are particularly fond of cats, though snakes and toads are also common. These animals lurk amid the clutter of the witches' lairs, seldom wandering far from their vile masters.

![{@creature Barovian Witch|CoS}](adventure/CoS/145-636379876850421049.png)
...
Ezmerelda keeps a deck of tarokka cards in her wagon (chapter 11, **area area V1**). Although the cards aren't magical, Ezmerelda can use them to perform a card reading for the characters (see chapter 1), like the one that can be performed by Madam Eva.
...
![{@creature Izek Strazni|CoS}](adventure/CoS/147-636623996907006468.png)

#### Kasimir Velikov

Kasimir Velikov, a mutiliated and grief-stricken dusk elf, has been trapped in Barovia for centuries. His people were on the verge of being annihilated by Strahd's armies when they surrendered. Strahd left the few survivors to the mercy of the Vistani, who bore them to the valley of Barovia, where they have lived ever since.
...
- Kasimir has <wc-fetch type="sense">darkvision</wc-fetch> out to a range of 60 feet.
- Kasimir has the Fey Ancestry feature, which means he has advantage on saving throws against being <wc-fetch type="condition">charmed</wc-fetch>, and magic can't put him to sleep.
- Kasimir wears a <wc-fetch type="item">ring of warmth</wc-fetch> and carries a spellbook (see chapter 5, **area area N9a**, for a list of the spells it holds in addition to his prepared spells).
...
![{@creature Mongrelfolk|CoS}](adventure/CoS/148-636985373100391611.jpeg)
...
A phantom warrior retains the alignment and personality it had before it died, and it remembers how it died. Memories of its life from shortly before it died are hazy, and older memories are forgotten. A phantom warrior can usually remember the last <wc-roll>1d10 + 10</wc-roll> days of its life; everything that happened before that is an impenetrable fog.
...
![{@creature Phantom Warrior|CoS}](adventure/CoS/149-636623996440271782.png)
...
![{@creature Pidlwick II|CoS}](adventure/CoS/150-636623996229835683.png)
...
![{@creature Rictavio|CoS}](adventure/CoS/152-636623995708971736.png)
...
Although Strahd can be encountered almost anywhere in his domain, the vampire is always encountered in the place indicated by the card reading in **area chapter 1**, unless he has been forced into his **area tomb** in the catacombs of **area Castle Ravenloft**.
...
- Strahd knows when he's in over his head. If he begins taking more damage than he can regenerate, he moves beyond the reach of melee combatants and spellcasters, or he flies away (using summoned Wolf or Swarm of Bats or Swarm of Rats to guard his retreat).
- Strahd observes the characters to see who among them are most easily swayed, then tries to charm characters who have low Wisdom scores and use them as thralls. At the very least, he can order a <wc-fetch type="condition">charmed</wc-fetch> character to guard him against other members of the adventuring party.

##### The Vampire's Minions

Whenever Strahd appears in a location other than his tomb or the place indicated by the card reading, roll a <wc-roll>d20</wc-roll> and consult the Strahd's Minions table to determine what creatures he brings with him, if any.

##### Strahd's Minions

| <span class="text-center block">d20</span> | Creatures |
| - | - |
| <span class="text-center block">1–3</span> | <wc-roll>1d4 + 2</wc-roll> Dire Wolf |
| <span class="text-center block">4–6</span> | <wc-roll>1d6 + 3</wc-roll> Ghoul |
| <span class="text-center block">7–9</span> | <wc-roll>1d4 + 2</wc-roll> Strahd Zombie (in this **area appendix**) |
| <span class="text-center block">10–12</span> | <wc-roll>2d4</wc-roll> Swarm of Bats |
| <span class="text-center block">13–15</span> | <wc-roll>1d4 + 1</wc-roll> Vampire Spawn |
| <span class="text-center block">16–18</span> | <wc-roll>3d6</wc-roll> Wolf |
| <span class="text-center block">19–20</span> | None |
...
The ability of the Heart of Sorrow to absorb damage is suppressed if it or Strahd is fully within an <wc-fetch type="spell">antimagic field</wc-fetch>.

##### Lair Actions

While Strahd is in Castle Ravenloft, he can take lair actions as long as he isn't <wc-fetch type="condition">incapacitated</wc-fetch>.
...
- Strahd targets one Medium or smaller creature that casts a shadow. The target's shadow must be visible to Strahd and within 30 feet of him. If the target fails a DC 17 Charisma saving throw, its shadow detaches from it and becomes a shadow that obeys Strahd's commands, acting on initiative count 20. A <wc-fetch type="spell">greater restoration</wc-fetch> spell or a <wc-fetch type="spell">remove curse</wc-fetch> spell cast on the target restores its natural shadow, but only if its undead shadow has been destroyed.

![{@creature Strahd von Zarovich|CoS}](adventure/CoS/153-636988936829621698.jpeg)

#### Strahd Zombie

Strahd Zombie are undead that serve the vampire Strahd von Zarovich. Created from the long-dead guards of Castle Ravenloft, they were called into being through dark magic by Strahd himself.
...
- Vladimir wields a <wc-fetch type="item">+2 Greatsword</wc-fetch> with a hilt sculpted to resemble silver dragon wings and a pommel shaped like a silver dragon's head clutching a black opal between its teeth. As an action, he can make two attacks with the sword (+9 to hit). It deals 20 (<wc-roll>4d6 + 6</wc-roll>) slashing damage on a hit. Against Strahd, Vladimir deals an extra 14 (<wc-roll>4d6</wc-roll>) slashing damage with the weapon.
- Vladimir has a challenge rating of 7 (2,900 XP).

![undefined](adventure/CoS/154-cos19-11.png)
...
Wereraven are secretive and extraordinarily cautious lycanthropes that trust one another but are wary of just about everyone else. Although skilled at blending into society, they keep mostly to themselves, respect local laws, and strive to do good whenever possible.
...
![{@creature Wereraven|CoS}](adventure/CoS/155-637515969684846750.png)